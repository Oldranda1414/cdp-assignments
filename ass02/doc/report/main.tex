...
A map monitor is created (\texttt{RWTreeMonitor.java}) to save the current results. To implement the pausing and resuming functions in the
 ...
 implementation sets the color of the semaphore depending on orders from the GUI

\section{Execution and Testing}
The main class \texttt{macriopart2/Main.java} creates the desired implementation of \texttt{WordCounter}.
