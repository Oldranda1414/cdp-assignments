...
\end{itemize}
We also tried to use \emph{Java Path Finder} but after converting all the codebase into Java 8, solving uncountable issues with gradle and having still compile errors thrown, we decided to give it a chance in the future (i.e. never).
